...
namespace Tetris
{
    class JPiece : Tetromino
    {
        ...
        public override List<Vector2> Rotate(List<Vector2> current, rotations currentRotation, rotationDirection direction, ref char?[,] array)
        {
            ...
            {
                return new List<Vector2> { new Vector2(centerX, centerY + 1.5f), new Vector2(centerX + 1, centerY + 0.5f), new Vector2(centerX, centerY + 2.5f), new Vector2(centerX, centerY + 0.5f) };
            }
            if (currentRotation == rotations.rotation1 && direction == rotationDirection.counterclockwise)
            {
                return new List<Vector2> { new Vector2(centerX, centerY + 1.5f), new Vector2(centerX - 1, centerY + 2.5f), new Vector2(centerX, centerY + 2.5f), new Vector2(centerX, centerY + 0.5f) };
            }

            if (currentRotation == rotations.rotation2 && direction == rotationDirection.clockwise)
            {
                return new List<Vector2> { new Vector2(centerX + 0.5f, centerY), new Vector2(centerX + 1.5f, centerY + 1), new Vector2(centerX + 1.5f, centerY), new Vector2(centerX - 0.5f, centerY) };
            }
            ...
            {
                return new List<Vector2> { new Vector2(centerX, centerY + 0.5f), new Vector2(centerX - 1, centerY + 1.5f), new Vector2(centerX, centerY + 1.5f), new Vector2(centerX, centerY - 0.5f) };
            }
            ...
            {
                return new List<Vector2> { new Vector2(centerX + 1.5f, centerY), new Vector2(centerX + 0.5f, centerY - 1), new Vector2(centerX + 2.5f, centerY), new Vector2(centerX + 0.5f, centerY) };
            }
            if (currentRotation == rotations.rotation4 && direction == rotationDirection.counterclockwise)
            {
                return new List<Vector2> { new Vector2(centerX + 1.5f, centerY), new Vector2(centerX + 2.5f, centerY + 1), new Vector2(centerX + 2.5f, centerY), new Vector2(centerX + 0.5f, centerY) };
            }
